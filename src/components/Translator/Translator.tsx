...
export const Translator: FC<TranslatorProps> = (props) => {
  ...
  return (
    <form className="flex flex-col gap-4 mt-4" action={submitAction}>
    ...
    <div className="flex flex-col w-full gap-2 lg:flex-row">
      ...
      <div className="flex-1">
        <div className="w-full h-full text-lg p-2 min-h-64  bg-zinc-100 border-zinc-300 rounded border dark:bg-zinc-900 dark:border-zinc-700">
          {translation}
        </div>
      </div>
    </div>
    ...
    <div className="flex justify-between">
      <div className="flex-1">
      {error != null && (
        <div id="error-message" role="alert" className="text-red-600 dark:text-red-400">
          {error}
        </div>
      )}
      </div>
